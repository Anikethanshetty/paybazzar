      ...
      <div className=" p-6 ">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-2xl font-semibold text-primary">Utility Payments</h1>
          </div>
        ...
        {filteredServices.length === 0 && (
          <div className="text-center py-20">
            <div className="bg-gradient-light rounded-2xl p-12 max-w-md mx-auto shadow-paybazaar-card">
              ...
              <h3 className="text-xl font-bold text-foreground mb-3">No services found</h3>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-muted border-b border-border">
                  <tr>
                    <th className="text-left p-4 font-semibold text-sm text-muted-foreground uppercase tracking-wider">Ref ID</th>
                    <th className="text-left p-4 font-semibold text-sm text-muted-foreground uppercase tracking-wider">Category</th>
                    <th className="text-left p-4 font-semibold text-sm text-muted-foreground uppercase tracking-wider">Biller Name</th>
                    ...
                    <th className="text-left p-4 font-semibold text-sm text-muted-foreground uppercase tracking-wider">Actions</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border">
                  {recentTransactions.map((transaction, index) => (
                    <tr key={transaction.refId} className={`hover:bg-muted/50 transition-colors ${index % 2 === 0 ? 'bg-background' : 'bg-muted/20'}`}>
                      <td className="p-4 text-sm font-mono text-foreground">{transaction.refId}</td>
                      <td className="p-4 text-sm text-foreground">{transaction.category}</td>
                      <td className="p-4 text-sm text-foreground">{transaction.billerName}</td>
                      <td className="p-4 text-sm font-semibold text-foreground">{transaction.amount}</td>
                      <td className="p-4 text-sm text-foreground">{transaction.customerName}</td>
                      <td className="p-4">
                        <Badge 
                          variant={
                      ...
                      <td className="p-4">
                        <div className="flex gap-2">
                          <Button size="sm" variant="outline" className="h-8 w-8 p-0 rounded-full hover:bg-primary hover:text-primary-foreground">
